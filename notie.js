 ...
 *
 */
/* jshint strict:true, noempty:true, noarg:true, eqeqeq:true, browser:true, bitwise:true, curly:true, undef:true, nonew:true, forin:true */
/* global define: true, exports: true, require: true, module: true */
(function (root, factory) {
    'use strict';
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define('notie', factory);
    ...
    var notie = function () {
        ...
        confirm_backdrop.onclick = function () {
            confirm_hide();
        };
        ...
        input_backdrop.onclick = function () {
            input_hide();
        };
